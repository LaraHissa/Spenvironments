...
class speciation_model{
    private:   
        ...
        // --- Biological & Environmental Calculations ---
        ...
        pair<map<int,int>,int> check_species(graph &net, const double &G); // Clustering/Speciation analysis
    
        // --- Analytical & Auxiliary Methods ---
...
bool speciation_model::try_reproduce(graph &net, int i, const float &qmating, const float &MutationRate, const double &S,
    ...
    // Prevent extra offspring if the node is a "hub" 
